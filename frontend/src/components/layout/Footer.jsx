        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              <a href="#" className="rounded-full border border-border p-2 hover:bg-muted transition" aria-label="LinkedIn">
              ...
              <a href="#" className="rounded-full border border-border p-2 hover:bg-muted transition" aria-label="Twitter">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" className="rounded-full border border-border p-2 hover:bg-muted transition" aria-label="GitHub">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="mailto:support@mtpocket.com" className="rounded-full border border-border p-2 hover:bg-muted transition"><Mail className="h-5 w-5"/></a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-muted-foreground">
              ...
              <Link to="/trust-safety" className="block hover:text-primary">Trust &amp; Safety</Link>
          ...
          <div>
            ...
            <div className="space-y-3 text-muted-foreground">
              <Link to="/terms" className="block hover:text-primary">Terms &amp; Conditions</Link>
              <Link to="/privacy" className="block hover:text-primary">Privacy Policy</Link>
              <a href="mailto:support@mtpocket.com" className="block hover:text-primary">Support Email</a>
            </div>
          </div>
        </div>
