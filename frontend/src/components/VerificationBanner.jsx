      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-4 sm:bottom-6 left-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 rounded-2xl border border-amber-500/30 bg-card shadow-2xl p-5 sm:p-6"
          >
            {/* Header */}
